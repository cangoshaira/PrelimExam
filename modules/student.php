...
<body class="font-family-acme bg-gradient-to-t from-[#54b2bbe7] to- [#34336b] h-screen">
	...
	<div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2">
		...
		<!--Title-->
		<h1 class="flex items-center font-sans font-bold break-normal text-rose-400 px-2 py-8 text-xl md:text-2xl">
		List of Students</a> Table
		</h1>
        <!-- TABLE CONSTRUCTION -->
